...
> Build an applicant-first platform that helps users compare NPS directions, understand what they will study, narrow choices through a lightweight guided flow, and later support admissions analytics and editorial promotion.

## Milestones

- [x] ~~**Foundation**~~ - choose the stack, bootstrap the application, and establish the modular monolith base with shared domains and initial infrastructure
- [x] ~~**Catalog And NPS Comparison**~~ - deliver the applicant-facing catalog, direction pages, and comparison flow for 2-4 NPS directions
